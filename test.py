...
if __name__ == '__main__':
    ...
    if map_calc:
        T.mAP()
        print 'Average time = ' + str(time / num1)
    elif test_2012:
        T.voc_2012_test()
    else:
        ...
        # print(images)
        # print (np.random.choice(images))
        path = '/home/mzx/Stronger-yolo/data/test_data/'
        outpath = '/home/mzx/Stronger-yolo/data/result/'
        ...
        for imagename in os.listdir(path):
            ...
            cv2.imwrite(outpath+imagename, image)
        print 'Average time = '+ str(time/num1)
